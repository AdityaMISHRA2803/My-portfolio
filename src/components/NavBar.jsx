					...
					<div className='desktop'>
						<div className="flex space-x-5 justify-center items-center pl-2">
							<ul className="flex space-x-4 dark:text-white">
								...
								<li>
									<Link to='/projects' className={pageLocation.pathname === '/projects' ? 'text-blue-500 font-semibold' : 'hover:text-blue-600'}>My Projects</Link>
								</li>
								<li>
							...
							<a className='hover:scale-110 transition' target='_blank' href="https://github.com/AdityaMISHRA2803">
							...
							<a className='!ml-2 hover:scale-110 transition' target='_blank' href="https://www.linkedin.com/in/aditya-mishra-iiit/">
